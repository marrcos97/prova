...
public class FuncionarioDepartamentoDTO implements Serializable {
	...
	public FuncionarioDepartamentoDTO() {
	}

	public FuncionarioDepartamentoDTO(Funcionario funcionario) {
